...
class AdminHostelRules extends StatefulWidget {
  const AdminHostelRules({super.key});

  @override
  State<AdminHostelRules> createState() => _AdminHostelRulesState();
}

class _AdminHostelRulesState extends State<AdminHostelRules> {
