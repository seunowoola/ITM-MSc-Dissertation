...
class UserPhotoUpload extends StatefulWidget {
  const UserPhotoUpload({Key? key}) : super(key: key);

  @override
  State<UserPhotoUpload> createState() => _UserPhotoUploadState();
}
        ...
        child: Padding(
          ...
          child: ListView(
            children:  [
              ...
              const Center(child: Text("Upload Profile Photo", style: TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w600),)),
          ...
          //
              Row(
                ...
                children: [
                  ...
                  selectedPassportImage.isEmpty ? Flexible(child: ButtonWidget(title: "Submit", width: 200,
                  onTap: (){
                    Fluttertoast.showToast(msg: "Please select an Image");
                  },))
                      : Flexible(
                    child: ButtonWidget(title: "Submit", width: 200,
                      onTap: ()async{
                        setState(() {
                          isLoading = true;
                        });
                        ...
                        _appLogic.uploadRegisterUserPhoto(passportUrl: passportImageFireStoreUrl,
                            stopLoading: (){
                              setState(() {
                                isLoading = false;
                              });
